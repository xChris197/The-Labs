...
public class SCR_FirstSlot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (distance < 2f && SCR_PlayerCasting.hitTarget.CompareTag("First Slot"))
        {
            firstTimeNotActive = true;
            idleCrosshairOne.SetActive(false);
            interactionUIOne.SetActive(true);
            textDisplayOne.text = "[First Slot]\n Press 'X' To Interact";
        }
        ...
        if (distanceTwo < 2f && SCR_PlayerCastingTwo.hitTarget.CompareTag("First Slot"))
        {
        ...
        if (distance < 2f && SCR_PlayerCasting.hitTarget.CompareTag("First Slot") && !bIsInteracting && (Input.GetButtonDown(interactOne)))
        {
            bPlayerOneUsing = true;
            UseSlotOne();
        }
        else if (distanceTwo < 2f && SCR_PlayerCastingTwo.hitTarget.CompareTag("First Slot") && !bIsInteracting && (Input.GetButtonDown(interactTwo)))
        {
    ...
    public void AddHydrogenPeroxide()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasHydrogenPeroxide)
            {
                ...
                makerManager.AddFirstChemical(1);
    ...
    public void AddSulphuricAcid()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasSulphuricAcid)
            {
                ...
                makerManager.AddFirstChemical(2);
    ...
    public void AddAcetone()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasAcetone)
            {
                ...
                makerManager.AddFirstChemical(3);
    ...
    public void AddIsopropanyl()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasIsopropanyl)
            {
                ...
                makerManager.AddFirstChemical(4);
    ...
    public void AddSodiumHypochlorite()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasBleach)
            {
                ...
                makerManager.AddFirstChemical(5);
    ...
    public void AddPicricAcid()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasSulphuricAcid)
            {
                ...
                makerManager.AddFirstChemical(6);

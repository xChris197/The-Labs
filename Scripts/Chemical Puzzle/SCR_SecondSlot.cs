...
public class SCR_SecondSlot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (distance < 2f && SCR_PlayerCasting.hitTarget.CompareTag("Second Slot"))
        {
            firstTimeNotActive = true;
            idleCrosshairOne.SetActive(false);
            interactionUIOne.SetActive(true);
            textDisplayOne.text = "[Second Slot]\n Press 'X' To Interact";
        }
        ...
        if (distanceTwo < 2f && SCR_PlayerCastingTwo.hitTarget.CompareTag("Second Slot"))
        {
        ...
        if (distance < 2f && SCR_PlayerCasting.hitTarget.CompareTag("Second Slot") && !bIsInteracting && (Input.GetButtonDown(interactOne)))
        {
            bPlayerOneUsing = true;
            UseSlotOne();
        }
        else if (distanceTwo < 2f && SCR_PlayerCastingTwo.hitTarget.CompareTag("Second Slot") && !bIsInteracting && (Input.GetButtonDown(interactTwo)))
        {
    ...
    public void AddHydrogenPeroxide()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasHydrogenPeroxide)
            {
                ...
                makerManager.AddSecondChemical(1);
    ...
    public void AddSulphuricAcid()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasSulphuricAcid)
            {
                ...
                makerManager.AddSecondChemical(2);
    ...
    public void AddAcetone()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasAcetone)
            {
                ...
                makerManager.AddSecondChemical(3);
    ...
    public void AddIsopropanyl()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasIsopropanyl)
            {
                ...
                makerManager.AddSecondChemical(4);
    ...
    public void AddSodiumHypochlorite()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasBleach)
            {
                ...
                makerManager.AddSecondChemical(5);
    ...
    public void AddPicricAcid()
    {
        ...
        if (bPlayerOneUsing)
        {
            if (SCR_InventoryOne.bHasSulphuricAcid)
            {
                ...
                makerManager.AddSecondChemical(6);
